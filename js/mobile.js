...
document.addEventListener('DOMContentLoaded', function() {
    if (!window.mobileCheck()) {
        ...
        const elementCartpopup = document.getElementsByClassName('info-narrow');
        if (elementCartpopup.length > 0) {
            Array.from(elementCartpopup).forEach((element) => element.remove());
        }
    } else {
        ...
        document.getElementById('info-title').addEventListener('click', function() {
            const infoDiv = document.querySelector('.about');
        ...
        document.getElementById('info-contact').addEventListener('click', function() {
            const infoDiv = document.querySelector('.contact');
        ...
        document.querySelector('#info-payment h3').addEventListener('click', function() {
            const infoDiv = document.querySelector('#info-payment .payments-div');
        ...
        const elementCartpopup = document.getElementsByClassName('cart-popup');
        if (elementCartpopup.length > 0) {
            Array.from(elementCartpopup).forEach((element) => element.remove());
        }
...
if (window.innerWidth <= 768) {
  const categoryById = document.getElementById('other-category');
  if (categoryById) {
    categoryById.remove();
  }

  const categories = document.querySelectorAll('.other-category');
  categories.forEach((element) => element.remove());
}